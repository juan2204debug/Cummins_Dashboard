...
--- a/src/App.jsx
+++ b/src/App.jsx
@@ -45,140 +45,163 @@ async function getFB() {
...
@@ -262,58 +285,65 @@ export default function App(){
...
+    if(!newFiles.length){setLoading(false);alert("No se encontraron archivos Excel válidos (.xlsx o .xls).");return;}
     setAllRecs(prev=>{
...
@@ -1317,51 +1347,51 @@ export default function App(){
